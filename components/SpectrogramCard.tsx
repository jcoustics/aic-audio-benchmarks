...
export default function SpectrogramCard({ title, imagePath, audioPath }: SpectrogramCardProps) {
  ...
  return (
    <div className="group space-y-4">
      ...
      <div className="relative bg-white rounded-2xl overflow-hidden shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] hover:shadow-md transition-all duration-300">
      ...
      {/* Title */}
      <h3 className="font-light text-gray-900 text-base md:text-lg text-center tracking-tight whitespace-nowrap">{title}</h3>
    </div>
  );
}
